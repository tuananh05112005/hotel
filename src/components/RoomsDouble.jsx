...
const RoomCard = ({ image, title, guests, size, price }) => {
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden group">
      <div className="relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-white opacity-0 scale-x-0 group-hover:scale-x-100 group-hover:opacity-20
          transition-all duration-500 ease-in-out origin-left" />
        <div className="absolute inset-0 bg-white opacity-0 scale-y-0 group-hover:scale-y-100 group-hover:opacity-20
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="bg-red-600 text-white px-4 py-1 text-sm hover:bg-white hover:text-red-500 border-2 border-red-500 rounded-lg transition-colors uppercase">
            Đặt phòng
          </button>
        </div>
      </div>
...
const RoomsSection = () => {
  const rooms = [
    ...
    },
    {
      ...
      title: "Phòng Đôi View Thành Phố",
      guests: "02 Khách",
      size: "30m²",
      price: "1.100.000",
    },
  ...
  return (
    <section className="max-w-7xl mx-auto py-12 px-4">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-semibold mb-2">PHÒNG ĐÔI</h2>
